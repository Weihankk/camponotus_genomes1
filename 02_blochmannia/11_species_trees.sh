...
sumtrees.py --output=camp_bloch.tre --min-clade-freq=0.05 camp_bloch_genes.trees
...
java -jar ~/Astral/astral.5.6.3.jar -i camp_bloch_genes.trees -o camp_bloch_astral.tre 2> camp_bloch.log
